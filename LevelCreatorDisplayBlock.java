...
public class LevelCreatorDisplayBlock extends LevelCreatorObject
{
    ...
    public void act() 
    {
        ...
        if(m != null){
            ...
            if((Greenfoot.mouseClicked(this) && m.getButton() == 1) || (Greenfoot.isKeyDown("w")&& delay > 15)){
                delay = 0;
                block++;
            ...
            if((Greenfoot.mouseClicked(this) && m.getButton() == 3)|| (Greenfoot.isKeyDown("q") && delay > 15)){
                delay = 0;
                block--;
                if(block < 0){
