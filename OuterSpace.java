...
public class OuterSpace extends Space
{
    ...
    private void prepareObjects()
    {
        ...
        Planet planet3 = new Planet(-2000, 130,  new Level83(-2000,130), "images/Planet4.png", "4", 3);
        ...
        Planet planet11 = new Planet(19200, 2280,  new Level1(19200,2280), "images/Planet12.png", "11", 2);
        addObject(planet11,3000, 0);

        Planet planet12 = new Planet(17185, 1150,  new Level0(17185,1150), "images/Planet13.png", "12", 3);
        ...
        //Sector 3  done
        Planet planet13 = new Planet(-828, 4146,  new Level30(-828,4146), "images/Planet14.png", "13", 0);
        addObject(planet13,3000, 0);
        //purple

        Planet planet14 = new Planet(-1643, 5733,  new Level31(-1643,5733), "images/Planet16.png", "14", 1);
        addObject(planet14,3000, 0);
        //green planet

        Planet planet15 = new Planet(0, 5621,  new Level32(0,5621), "images/Planet15.png", "15", 2);
        addObject(planet15,3000, 0);
        //white planet

        Planet planet16 = new Planet(2143, 5782,  new Level33(2143,5782), "images/Planet9.png", "16", 3);
        addObject(planet16,3000, 0);
        //brown planet
        
        //Sector 4 done
         
         Planet planet17 = new Planet(6959, 4213,  new Level40(6959,4213), "images/Planet35.png", "17", 0);
        addObject(planet17,3000, 0);
        //blue
        

        Planet planet18 = new Planet(7704, 5698,  new Level41(7704,5698), "images/Planet37.png", "18", 1);
        addObject(planet18,3000, 0);
        //purple
        
        Planet planet19 = new Planet(8745, 5259,  new Level60(8745,5259), "images/Planet18.png", "19", 2);
        addObject(planet19,3000, 0);
        //rainbow

        Planet planet20 = new Planet(10192, 6102,  new Level61(10192,6102), "images/Planet36.png", "20", 3);
       ...
       //Sector 5  done 
        Planet planet21 = new Planet(15946, 6644,  new Level94(15946,6644), "images/Planet21re.png", "21", 0);
        addObject(planet21,3000, 0);
        //purple
        

        Planet planet22 = new Planet(16882, 6206,  new Level92(16882,6206), "images/planet19.png", "22", 1);
        addObject(planet22,3000, 0);
        //blue - 92

        Planet planet23 = new Planet(18745, 6045,  new Level13(18745,6045), "images/Planet20.png", "23", 2);
        addObject(planet23,3000, 0);
        //white 
        Planet planet24 = new Planet(18745, 3927,  new Level102(18745,3927), "images/Planet22.png", "24", 3);
       ...
       //*****************************************************************
        ...
        //Sector 6   done 
        Planet planet25 = new Planet(-2138, 11144,  new Level84(-2138,11144), "images/Planet25.png", "25", 0);
        addObject(planet25,3000, 0);
        //black planet
        

        Planet planet26 = new Planet(716, 11624,  new Level85(716,11624), "images/Planet26.png", "26", 1);
        addObject(planet26,3000, 0);
        //brown planet

        Planet planet27 = new Planet(-226, 10002,  new Level86(-226,10002), "images/Planet23.png", "27", 2);
        addObject(planet27,3000, 0);
        //blue planet

        Planet planet28 = new Planet(2536, 9563,  new Level87(2536,9536), "images/Planet24.png", "28", 3);
        ...
        //Sector 7  done
        Planet planet29 = new Planet(9310, 11979,  new Level14(9310,11979), "images/Planet28.png", "29", 0);
        addObject(planet29,3000, 0);
        //red 
        

        Planet planet30 = new Planet(10371, 10235,  new Level24(10371,10235), "images/Planet30.png", "30", 1);
        addObject(planet30,3000, 0);
        //orange

        Planet planet31 = new Planet(8432, 10083,  new Level25(8432,10083), "images/Planet29.png", "31", 2);
        addObject(planet31,3000, 0);
        //blue
        
        
        Planet planet32 = new Planet(6634, 10167,  new Level26(6634,10167), "images/Planet27.png", "32", 3);
        addObject(planet32,3000, 0);
        //peach
        
        // ******************************************************************************//
        //Sector 8  done
        Planet planet33 = new Planet(19562, 10304,  new Level5(19562, 10304), "images/Planet33.png", "33", 0);
        addObject(planet33,3000, 0);
        //pink
        

        Planet planet34 = new Planet(16887, 10999,  new Level9001(16887, 10999), "images/Planet34.png", "34", 1);
        addObject(planet34,3000, 0);
        //blue with circles

        Planet planet35 = new Planet(15920, 9333,  new Level000(15920, 9333), "images/Planet31.png", "35", 2);
        addObject(planet35,3000, 0);
        //green and blue

        Planet planet36 = new Planet(14893, 10957,  new Level100(14893, 10957), "images/Planet32.png", "36", 3);
